...
<body>
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                <div class="form-inline mr-auto">
                    <ul class="navbar-nav mr-3">
                        <li><a id="arrowIcon" href="#" data-toggle="sidebar"
                                class="nav-link nav-link-lg
									collapse-btn">
                                <i id="changedArrow" class="fa-solid fa-arrow-left" style="color: #000000;"></i></a>
                        </li>
                ...
                <ul class="navbar-nav navbar-right flex align-items-center justify-content-center">

                    <div class="dropdown dropdown-list-toggle">
                    ...
                    <li class="dropdown flex align-items-center justify-content-center">
                        <a href="" data-toggle="dropdown" class="dropdown-toggle flex align-items-center">
    ...
    <script>
        document.getElementById('arrowIcon').addEventListener('click', function() {
            document.getElementById('changedArrow').classList.toggle('fa-arrow-right');
